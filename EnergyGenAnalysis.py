...
for rate, hitr, hitp, hitdet, hitpid, hittrid, hitphi in uproot.iterate(["/home/seehrar/projects/rrg-jmammei/elhamm/PionDetectorOptimization/simulation/scratch1/showermaxPlaneAtFrontandBackNoFrameShiftedLucite1cm-WithAluminiumPlate-MoveOutRadially2cm/moller.root:T"], ['rate','hit.r','hit.p','hit.det', 'hit.pid', 'hit.trid','hit.ph'], library="ak", how = tuple):
    ...
    rate_jagged_c1=ak.flatten((ak.ones_like(hitp[c1])) * (rate/5.95e13))
    rate_jagged_c11=ak.flatten((ak.ones_like(hitp[c11])) * (rate/5.95e13))
...
plt.title(" Energy Spectrum (Detector {}), e + p ".format(Detector))
plt.xlabel("Energy (MeV)")
plt.ylabel("Detector {} Rate (Hz/30 MeV)  ".format((Detector)))
plt.yscale('log')
...
plt.legend()
plt.savefig("/home/seehrar/projects/rrg-jmammei/seehrar/simulation_analysis/cedar_2.0/analysis/EnergyAnalysis/gen_e_p_{}".format( timestr))

           
for rate, hitr, hitp, hitdet, hitpid, hittrid, hitphi in uproot.iterate(["/home/seehrar/projects/rrg-jmammei/elhamm/PionDetectorOptimization/simulation/scratch1/showermaxPlaneAtFrontandBackNoFrameShiftedLucite1cm-WithAluminiumPlate-MoveOutRadially2cm/moller.root:T"], ['rate','hit.r','hit.p','hit.det', 'hit.pid', 'hit.trid','hit.ph'], library="ak", how = tuple):
    c2 = (hitdet == 31) * (abs(hitpid)==13)
    c21 = (hitdet == 32) * (abs(hitpid)==13)
    rate_jagged_c2=ak.flatten((ak.ones_like(hitp[c2])) * (rate/5.95e13))
    rate_jagged_c21=ak.flatten((ak.ones_like(hitp[c21])) * (rate/5.95e13))
...
plt.title(" Energy Spectrum (Detector {}), muons ".format(Detector))
plt.xlabel("Energy (MeV)")
plt.ylabel("Detector {} Rate (Hz/2.5 MeV)  ".format((Detector)))
plt.yscale('log')
...
plt.legend()
plt.savefig("/home/seehrar/projects/rrg-jmammei/seehrar/simulation_analysis/cedar_2.0/analysis/EnergyAnalysis/gen_muons_{}".format(timestr))
           
           
for rate, hitr, hitp, hitdet, hitpid, hittrid, hitphi in uproot.iterate(["/home/seehrar/projects/rrg-jmammei/elhamm/PionDetectorOptimization/simulation/scratch1/showermaxPlaneAtFrontandBackNoFrameShiftedLucite1cm-WithAluminiumPlate-MoveOutRadially2cm/moller.root:T"], ['rate','hit.r','hit.p','hit.det', 'hit.pid', 'hit.trid','hit.ph'], library="ak", how = tuple):
    c3 = (hitdet == 31) * (abs(hitpid)==211)
    c31 = (hitdet == 32) * (abs(hitpid)==211)
    rate_jagged_c3=ak.flatten((ak.ones_like(hitp[c3])) * (rate/5.95e13))
    rate_jagged_c31=ak.flatten((ak.ones_like(hitp[c31])) * (rate/5.95e13))
...
plt.title(" Energy Spectrum (Detector {}), pions ".format(Detector))
plt.xlabel("Energy (MeV)")
plt.ylabel("Detector {} Rate (Hz/5 MeV)  ".format((Detector)))
plt.yscale('log')
...
plt.legend()
plt.savefig("/home/seehrar/projects/rrg-jmammei/seehrar/simulation_analysis/cedar_2.0/analysis/EnergyAnalysis/gen_pions_{}".format(timestr))